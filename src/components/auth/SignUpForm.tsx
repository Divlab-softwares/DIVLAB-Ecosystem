...
import { ChevronLeftIcon, EyeOff, EyeIcon } from "lucide-react";
    ...
    try {
      ...
      if (response.ok) {
        if (stayConnected) {
          ...
          router.refresh();
          router.push("/");
          router.refresh();// <--- Force le serveur à renvoyer les nouvelles infos de session
        } else {
          router.push("/signin");
          router.refresh();
        }
              ...
              <div className="space-y-5">
                ...
                <div className="flex flex-col items-start gap-3">
                  <div className="flex items-center gap-3">
                    <Checkbox checked={stayConnected} onChange={setStayConnected} />
                    <span className="block font-normal text-gray-700 text-theme-sm dark:text-gray-400">
                      Rester connecté après l'inscription
                    </span>
                  </div>
